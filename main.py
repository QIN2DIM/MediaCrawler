...
async def main():
    ...
    parser.add_argument(
        "--start", type=int, help="crawler type (number of start page)", default=config.START_PAGE
    )
    parser.add_argument(
        "--keywords", type=str, help="crawler type (please input keywords)", default=config.KEYWORDS
    )
